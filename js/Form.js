class Form {
  ...
  constructor() {
    ...
    this.logintitle = createElement('h5');
    ...
    this.input_chat = createInput("").attribute("placeholder", "Type a message");
...
hide9 = true;
    ...
    this.input_chat.position(displayWidth/2-650, 735);
    this.btn_send.position(3*(displayWidth/2-415)+178, 732);
    this.btn_send.style('width', '90px');
    this.btn_send.style('font-size', '13px');
    this.btn_send.style('height', '40px')
    var variable1=displayWidth-(((2*(displayWidth/2-415)))-165)+'px';

    this.input_chat.style('width', variable1);
    ...
    this.input_firstname.position(1440/2-150, 235);
    this.input_firstname.style('width', '100px');
    this.input_lastname.position(1440/2-30, 235);
    this.input_lastname.style('width', '100px');
    this.input_email.position(1440/2-150, 455);
    this.input_email.style('width', '220px');
    this.input_password.position(1440/2-150, 525);
    this.input_password.style('width', '220px');
    this.btn_go.position(1440/2-115, 590);
    this.btn_logout.hide();
    ...
    this.title1.html("Coca Cola Connect");
    this.title1.position(displayWidth/2-50, 62);
    this.title1.style('font-size', '60px');
    this.logintitle.html("Log In");
    this.logintitle.position(this.title1.x-200, 110);
    this.logintitle.style('font-size', '39px');
    this.title2.html("Connect with those that share your passion in this household beverage!");
    this.title2.position(displayWidth/2-50, 137);
    ...
    this.btn_login.position(displayWidth-282, 100);
    ...
    this.btn_logout.position(displayWidth-282, 100);
    ...
    */
    ...
    this.btn_aboutus.style('font-size', '10px');
                ...
                this.btn_login.mousePressed(()=>{ form.dostuff();
                  this.btn_login.hide();
                  adpos="regular"; console.log(adpos);
                  great=false;
                      });
                     ...
                     this.btn_seekeducation.mousePressed(()=>{ clicksound.play();
                        ...
                        this.seekeducationtitle.show();
                          ...
                          alertsound.play(); swal({
                            confirmButtonColor: '#CD853F', title: `Unsuccessful`,
...
hide8 = false;
                  ...
                  hide5 = false;
                      ...
                      this.btn_send.mousePressed(()=>{ 
                        ...
                        if(this.input_chat.value().length>=1 && this.input_chat.value()!==""){
                          if(CM1!==""&&CM2!==""&&CM3!==""&&CM4!==""&&CM5!==""&& CM6 !== "" && CM7 !== "" && CM8 !== "" && CM9 !== "" && CM10 !== "" && CM11 !== "" && CM12 !== "" && CM13 !== "" && CM14 !== "" && CM15 !== ""){
                            sendsound.play();
                            ...
                            CM1 = CM2;
                              ...
                              if(great==false){
                                fetchDateTime();
                              CM15 = date+" @ "+time+"     "+this.input_firstname.value() + " " + this.input_lastname.value() + ": "+this.input_chat.value();
                              } else if(great==true){
                                fetchDateTime();
                                CM15 = date+" @ "+time+"     "+"Anonymous: "+this.input_chat.value();
                              ...
                              Player.updateMessage7(CM7);
                              Player.updateMessage8(CM8);
                              Player.updateMessage9(CM9);
                              Player.updateMessage10(CM10);
                              Player.updateMessage11(CM11);
                              Player.updateMessage12(CM12);
                              Player.updateMessage13(CM13);
                              Player.updateMessage14(CM14);
                              Player.updateMessage15(CM15);

                          }else{
                            sendsound.play();

                            if(CM1 ===""){
                              CM1="";                              Player.updateMessage1(CM1);

                             

                      CM1 = this.input_firstname.value() + " " + this.input_lastname.value() + ": "+this.input_chat.value();
                    Player.updateMessage1(CM1);
                    } else if(CM2 ===""&&CM1!==""){
                      CM2="";                      Player.updateMessage1(CM2);

                     

                      CM2 = this.input_firstname.value() + " " + this.input_lastname.value() + ": "+this.input_chat.value();
                    Player.updateMessage2(CM2);
                    }else if(CM3 ===""&&CM2!==""&&CM1!==""){
                      CM3="";                      Player.updateMessage1(CM3);

                   

                      CM3 = this.input_firstname.value() + " " + this.input_lastname.value() + ": "+this.input_chat.value();
                    Player.updateMessage3(CM3);
                    }else if(CM4 ===""&&CM3!==""&&CM2!==""&&CM1!==""){
                      CM4="";                      Player.updateMessage1(CM4);



                      CM4 = this.input_firstname.value() + " " + this.input_lastname.value() + ": "+this.input_chat.value();
                    Player.updateMessage4(CM4);
                    }else if(CM5 ===""&&CM4!==""&&CM3!==""&&CM2!==""&&CM1!==""){
                      CM5="";                      Player.updateMessage1(CM5);

              

                      CM5 = this.input_firstname.value() + " " + this.input_lastname.value() + ": "+this.input_chat.value();
                    Player.updateMessage5(CM5);
                    }else if(CM6 ===""&&CM5 !==""&&CM4!==""&&CM3!==""&&CM2!==""&&CM1!==""){
                      CM6="";                      Player.updateMessage1(CM6);

               

                      CM6 = this.input_firstname.value() + " " + this.input_lastname.value() + ": "+this.input_chat.value();
                      Player.updateMessage6(CM6);
                      }
                  }
                        }
                ...
                this.btn_submitenvironment.mousePressed(()=>{ clicksound.play();
                  ...
                  if(this.input_environment.value().length<1 || this.input_environment.value()===""){
                    alertsound.play(); swal({
                      confirmButtonColor: '#CD853F', title: `Unsuccessful Submission`,
                  ...
                  alertsound.play(); swal({
                    confirmButtonColor: '#CD853F', title: `Successful Submission`,
            ...
            form.hidefunc2();
                ...
                this.btn_resetprogress.mousePressed(()=>{ clicksound.play();
                  ...
                  alertsound.play(); swal({
                    confirmButtonColor: '#CD853F', title: 'Are you sure you would like to reset your progress?',
                ...
                this.btn_fakehome.mousePressed(()=>{ clicksound.play();
                  ...
                  alertsound.play(); swal({
                    confirmButtonColor: '#CD853F', title: 'Are you sure you would like to exit this app?',
                    text: "You won't be able to revert this!",
                    type: 'warning',
                    showCancelButton: true,
                    confirmButtonColor: '#CD853F',
    ...
    this.btn_logout.mousePressed(()=>{ clicksound.play();alertsound.play();
      //console.log("btn_logout pressed");
      swal({
        confirmButtonColor: '#CD853F', title: `Logged Out`,
    ...
    this.btn_go.mousePressed(()=>{ clicksound.play();
      ...
      if(this.input_firstname.value().length<1 || this.input_firstname.value()===""||this.input_lastname.value().length<1 || this.input_lastname.value()===""||this.input_email.value().length<1 || this.input_email.value()===""||this.input_password.value().length<1 || this.input_password.value()===""){
        alertsound.play(); swal({
          confirmButtonColor: '#CD853F', title: `Unsuccessful Login`,
      ...
      hide6=false;
      adpos="odd"; console.log(adpos);

this.btn_send.show();
      loggedin = true;    this.socialmediatitle.show();

      alertsound.play(); swal({
        confirmButtonColor: '#CD853F', title: `Successfuly Logged In`,
